Contributing to Neiro Core
============================

The Neiro Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Neiro Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/neiro-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to neiro-qt
...
The following applies to code changes to the Neiro Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Neiro
Network Protocol consensus changes.

Whether a pull request is merged into Neiro Core rests with the project merge
...
Patches that change Neiro consensus rules are considerably more involved than
...
Where a patch set proposes to change the Neiro consensus, it must have been
...
The project leader is the release manager for each Neiro Core release.
